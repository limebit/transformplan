...
TransformPlan supports DuckDB as an alternative backend. All 87 operations, validation, and dry-run work identically — only the data type changes from Polars DataFrames to DuckDB relations.
